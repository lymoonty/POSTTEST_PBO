public class Aksesoris extends Produk {
    ...
    @Override
    public double hitungOngkir() { return 7000.0; }

    @Override
    public String getInfoDetail() { return "Kategori: Aksesoris | Bahan: " + material; }

    @Override
    public String getKategori() { return "Aksesoris"; }

    @Override
    public String getCiriKhas() { return "Material: " + material; }
}